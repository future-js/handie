 ...
 * @param {*} opts 包含抉择的配置项
 */
export function isNativeFlavor( opts ) {
 ...
 * @param {*} apis API
 */
export function setBridge( flag, apis ) {
 ...
 * @param {*} ref API 引用
 */
export function getBridge( flag, ref ) {
 ...
 */
export function resolveBridge( ref, isNativeFirst ) {
  if ( !isString(ref) ) {
    return;
  }
