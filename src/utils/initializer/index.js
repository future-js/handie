import { arrayEach, objectKeys, mixin } from "../common/helper";
import {
  ...
  arrayEach([
    {
      ...
      initializer: () => {
        ...
        mixin($.fn.modal.Constructor.DEFAULTS, {
          backdrop: defaults.dialog.backdrop,
          keyboard: defaults.dialog.closeOnEsc
        });
      }
    },
    {
      ...
      initializer: () => {
        ...
        mixin($.fn.bootstrapTable.defaults, {
          classes: defaults.table.classes,
          iconsPrefix: "fa",
          icons: {
            refresh: "fa-refresh",
            toggle: "fa-list-alt",
          ...
          queryParams: function( params ) {
            return jsonify(this.__$search
              ...
              .concat({
                ...
                name: defaults.table.keys.sort,
                value: params.sort
              }, {
                name: defaults.table.keys.order,
                value: params.order
              }]), function( jsonified ) {
                arrayEach(objectKeys(jsonified), function( k ) {
...
function initDialogs() {
  ...
  if ( defaults.watermark.mainOnly !== true ) {
...
$(document).ready(function() {
  ...
  if ( defaults.watermark.autoInit === true ) {
    utils.encrypt.watermark();
  }
